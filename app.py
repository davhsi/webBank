...
users = {
    "test": {"password": "test123", "balance": 1000},
    "test1": {"password": "test456", "balance": 500},
}
...
def dashboard():
    ...
    return render_template('dashboard.html', username=session['username'], balance=user['balance'], transactions=transactions)
